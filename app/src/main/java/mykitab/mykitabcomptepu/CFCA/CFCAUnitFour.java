 ...
 */
public class CFCAUnitFour extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("CFCA Unit Four");
...
*/
        ...
        try {
            ...
            employees = parser.parse(getAssets().open("cfca_unit_four.xml"));
