 ...
 */
public class CodeXMLAdapter extends ArrayAdapter<CodeXML> {

    // ImageLoader imageLoader;
    //DisplayImageOptions options;


    public CodeXMLAdapter(Context ctx, List<CodeXML> code) {
        super(ctx, 0, code);
...
*/
    ...
    public View getView(int pos, View convertView, ViewGroup parent) {
        ...
        if (null == row) {
            ...
            row = (RelativeLayout) inflater.inflate(R.layout.code, null);
        }
