 ...
 */
public class TOCUnitThree extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("TOC Unit Three");
        ...
        try {
            ...
            employees = parser.parse(getAssets().open("toc_unit_three.xml"));
