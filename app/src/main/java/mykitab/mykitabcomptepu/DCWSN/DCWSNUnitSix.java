 ...
 */
public class DCWSNUnitSix extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("DCWSN Unit Six");
...
*/
        ...
        try {
            ...
            employees = parser.parse(getAssets().open("dcwsn_unit_six.xml"));
