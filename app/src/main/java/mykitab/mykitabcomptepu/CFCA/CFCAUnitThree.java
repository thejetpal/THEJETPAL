 ...
 */
public class CFCAUnitThree extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("CFCA Unit Three");
        ...
        try {
            ...
            employees = parser.parse(getAssets().open("cfca_unit_three.xml"));
