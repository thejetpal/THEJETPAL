 ...
 */
public class OSDUnitThree extends AppCompatActivity {
...
// Initialize the Mobile Ads SDK.
        ...
        getSupportActionBar().setTitle("OSD Unit Three");
        ...
        try {
            ...
            employees = parser.parse(getAssets().open("osd_unit_three.xml"));
